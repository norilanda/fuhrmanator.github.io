...
aliases: 
  - ../../2020/12/18/Creating-questions-quickly-with-GIFT.html
date: 2020-12-18
categories: [Moodle, GIFT]
image: image.jpg
---
...
class "<img:pngkey.com-white-crown-png-859112.png{scale=0.7}>\nKEEP\nCALM\n<size:80>AND\nCLICK LESS TO\n<size:280>CREATE MORE" as A
@enduml
```
...
![GIFT in VSCode](GIFT_VSCode.gif)
...
![GIFT Editor web page](GIFT_Web.gif)
