...
class ClassB extends ClassA<string> {
  // ClassA is modeled as a ParametricClass with type string
  // ClassB and string are modeled as classes
}
```
...
Our metamodel includes 8 new classes: 
 ...
 - One: `ParameterType`, which refers to the parameters of a parametric element.
...
::: {.callout-note}
This example is explained in detail throughout this [blog post](https://modularmoose.org/moose-wiki/Developers/predefinedEntities#genericity).
:::
